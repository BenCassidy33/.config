...
_G.packer_plugins = {
  ...
  ["nvim-ts-autotag"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/nvim-ts-autotag",
  ...
  ["vim-jsx"] = {
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/vim-jsx",
  ...
  ["zen-mode.nvim"] = {
    ...
    loaded = true,
    path = "/home/ben/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
